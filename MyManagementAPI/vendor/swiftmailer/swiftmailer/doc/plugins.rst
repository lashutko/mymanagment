...
When you create your message, replace elements in the body (and/or the task
line) with your placeholders::

    $message = (new Swift_Message())
      ->setTask('Important notice for {username}')
      ->setBody(
...
.. code-block:: text
    ...
    Task: Important notice for smilingsunshine2009
...
.. code-block:: text
    ...
    Task: Important notice for billy-bo-bob
