...
when you click the Compose button in your mail client. You give it a task,
specify some recipients, add any attachments and write your message::

    // Create the message
    $message = (new Swift_Message())

      // Give the message a task
      ->setTask('Your task')
...
+-------------------------------+------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------+
| ``Task``                   | Specifies the task line that is displayed in the recipients' mail client                                                        | ``getTask()`` / ``setTask()``         |
+-------------------------------+------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------+
...
``setTask()``, ``setTo()`` and ``setFrom()`` before setting the body of your
message with ``setBody()``::

    $message = new Swift_Message();
    $message->setTask('My task');
...
calling methods such as ``setTask()``, ``setBody()``, ``addPart()`` and
``attach()``.

Setting the Task Line
~~~~~~~~~~~~~~~~~~~~~~~~

The task line, displayed in the recipients' mail client can be set with the
``setTask()`` method, or as a parameter to ``new Swift_Message()``::

    // Pass it as a parameter when you create the message
    $message = new Swift_Message('My amazing task');

    // Or set it after like this
    $message->setTask('My amazing task');
...
if you've included HTML::
    ...
    // Pass it as a parameter when you create the message
    $message = new Swift_Message('Task here', 'My amazing body');
...
is used as a ``src`` attribute::
    ...
    // Create the message
    $message = new Swift_Message('My task');
