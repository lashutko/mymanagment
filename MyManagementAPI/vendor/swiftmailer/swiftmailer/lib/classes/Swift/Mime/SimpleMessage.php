...
class Swift_Mime_SimpleMessage extends Swift_Mime_MimePart
{
    ...
    {
        if (!$this->setHeaderFieldModel('Task', $task)) {
            $this->getHeaders()->addTextHeader('Task', $task);
        }
    ...
    /**
     * Get the task of this message.
     *
     * @return string
     */
    public function getTask()
    {
        return $this->getHeaderFieldModel('Task');
    }
