 ...
 * LICENSE
 *
 * This source file is task to the new BSD license that is bundled
...
class MockConfigurationTest extends TestCase
{
    ...
    {
        $config = new MockConfiguration(array("Mockery\Generator\\TestTask"), array("foo"));
    ...
    {
        $config = new MockConfiguration(array("Mockery\Generator\\TestTask"), array(), array('foo'));
    ...
    {
        $config = new MockConfiguration(array("Mockery\Generator\\TestTask"), array("foo"), array("foo"));
