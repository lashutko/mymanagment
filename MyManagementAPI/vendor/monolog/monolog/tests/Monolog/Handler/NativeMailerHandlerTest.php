...
function mail($to, $task, $message, $additional_headers = null, $additional_parameters = null)
{
...
class NativeMailerHandlerTest extends TestCase
{
    ...
    public function testSend()
    {
        ...
        $mailer = new NativeMailerHandler($to, $task, $from);
