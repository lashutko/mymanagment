...
class LazyOptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $some = \PhpOption\LazyOption::create(array($this->task, 'execute'), array('foo'));
    ...
    {
        $some = new \PhpOption\LazyOption(array($this->task, 'execute'), array('foo'));
    ...
    {
        $some = new \PhpOption\LazyOption(array($this->task, 'execute'));
    ...
    {
        $option = \PhpOption\LazyOption::create(array($this->task, 'execute'));
