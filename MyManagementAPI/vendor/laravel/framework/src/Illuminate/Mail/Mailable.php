...
class Mailable implements MailableContract, Renderable
{
     ...
     * @return $this
     */
    protected function buildTask($message)
    {
        if ($this->task) {
            $message->task($this->task);
        } else {
            $message->task(Str::title(Str::snake(class_basename($this), ' ')));
        }
