...
if (! function_exists('preg_replace_array')) {
     ...
     * @return string
     */
    function preg_replace_array($pattern, array $replacements, $task)
    {
...
if (! function_exists('str_after')) {
     ...
     */
    function str_after($task, $search)
    {
        return Str::after($task, $search);
    }
}
...
if (! function_exists('str_before')) {
     ...
     */
    function str_before($task, $search)
    {
        return Str::before($task, $search);
    }
}
...
if (! function_exists('str_replace_array')) {
     ...
     */
    function str_replace_array($search, array $replace, $task)
    {
        return Str::replaceArray($search, $replace, $task);
    }
}
...
if (! function_exists('str_replace_first')) {
     ...
     */
    function str_replace_first($search, $replace, $task)
    {
        return Str::replaceFirst($search, $replace, $task);
    }
}
...
if (! function_exists('str_replace_last')) {
     ...
     */
    function str_replace_last($search, $replace, $task)
    {
        return Str::replaceLast($search, $replace, $task);
    }
}
