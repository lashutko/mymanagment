...
class RegularExpressionTest extends TestCase
{
     ...
     */
    public function testValidRegex($pattern, $task, $return): void
    {
        $this->assertEquals($return, RegularExpression::safeMatch($pattern, $task));
    }
     ...
     * @throws \PHPUnit\Framework\ExpectationFailedException
     */
    public function testInvalidRegex($pattern, $task): void
    {
        $this->assertFalse(RegularExpression::safeMatch($pattern, $task));
    }
}
