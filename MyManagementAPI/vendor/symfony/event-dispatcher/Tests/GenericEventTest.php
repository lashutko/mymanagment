...
class GenericEventTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->event = new GenericEvent($this->task, ['name' => 'Event']);
    }
    ...
    {
        $this->assertEquals($this->event, new GenericEvent($this->task, ['name' => 'Event']));
    }
    ...
    {
        $this->assertSame($this->task, $this->event->getTask());
    }
