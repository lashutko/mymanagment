<template>
   <div class="container">
        ...
        <div class="col-12 navigation_buttons">
          <ul>
              <li><router-link class="nav-button" :to="'/project/edit/' + project.id">Edit Project</router-link></li>
              <li><router-link class="nav-button" :to="'/attandancelist/' + project.id">Show attendance list</router-link></li>
          </ul>
       </div>
    </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    if(this.project){
      ...
      this.$router.push('/projects/'+ task_id); 
    }
  },  
  methods: {
