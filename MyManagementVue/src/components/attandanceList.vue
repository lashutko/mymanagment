        ...
        <div class="row">
          <section class="col-12 header">
            <h1>Select activity:</h1>
              <select v-model="activity" class="projectId" @change="getProgrammersAll()">    
...
export default {
  ...
  methods: {
      getActivities(){
        axios.get('http://vps758869.ovh.net/api/activities')
      ...
      addToList(id){
        ...
        this.attandanceList.push({programmer_id: id, activity_id: this.activity.id, data_presence: dateTime});
