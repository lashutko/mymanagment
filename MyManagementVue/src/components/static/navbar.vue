          ...
          <div class="row">
              <div class="col-12 top">
                  <header class="col-3 header">
                    <a href="/tasks"><img class="logo" src="../../assets/logo.png" v-if="!getAdmin"></a>
                  ...
                  <nav class="col-6 navbar" v-if="getAdmin">
                    <ul>
                      <li><router-link to="/programmers">Programmers</router-link></li>
                      <li><router-link to="/curators">Curators</router-link></li>
...
export default {
  ...
  computed: {
    getName(){
      if(localStorage.getItem('curatorName')){
        return localStorage.getItem('curatorName');
      }
    },
    getAdmin(){
